-- Create the missing is_valid_linkedin_url function directly without checking existence
-- This is a simpler approach that will work in most Supabase environments
