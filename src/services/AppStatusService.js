...
export class AppStatusService {
  ...
  static async checkUserOnboardingStatus(userId) {
    if (!userId) {
      return {
        status: 'no_user',
    ...
    try {
      ...
      return {
        ...
        profile_progress: founder.profile_progress,
  ...
  static async runFullDiagnostic(userId = null) {
    const diagnostic = {
      timestamp: new Date().toISOString(),
