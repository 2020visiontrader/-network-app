...
class AuthService {
  ...
  async signUp(email, password, profile) {
    try {
      ...
      if (data && data.token) {
        ...
        this._currentUser = data.founder;
      }
  ...
  isAuthenticated() {
    return !!(this._currentSession && this._currentUser);
  }
  ...
  async getAuthenticatedClient() {
    ...
    await supabase.rpc('set_founder_context', {
      p_founder_id: this._currentUser.id
    });
